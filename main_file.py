...
def game():
    ...
    dx, dy = 4,4 #speed of the ball in the horizontal and vertical directions
    x1,y1 = 90,150 #x1 and y1 are the coordinates of the top-left corner of the ball
    x2,y2 = 100,160 #x2 and y2 are the coordinates of the bottom-right corner.
    bar_start = 50 
    bar_lvl = 410 
    bricks_start_x = 10 
    bricks_start_y = 50 
